...
# I can also find the datatype for the age variable 
print(type(moms_age))
print(type(dads_age))
...
age_of_hancockhighschool = input("what is your age at hancock high school")
# print out the age of hancock high shcool and get your age in a sentence 
print(f" i am {age} and the age of hancock high school is {age_of_hancockhighschool}")
